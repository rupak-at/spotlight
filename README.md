...
- A 680×96 search bar that expands to a compact 680×460 result panel only after typing, with system application icons and file-type icons from Ubuntu's theme.
