...
Open the [latest GitHub Release](https://github.com/rupak-at/spotlight/releases/latest) and download the `.deb` asset. Releases currently provide an x86_64 package built on Ubuntu 24.04, named like `Spotlight_0.3.0_amd64.deb`.
...
```sh
git tag -a v0.3.0 -m "Spotlight v0.3.0"
